...
class FooterAlvin extends StatefulWidget {
  const FooterAlvin({super.key});

  @override
  State<FooterAlvin> createState() => _FooterAlvinState();
}

class _FooterAlvinState extends State<FooterAlvin> {
  @override
  Widget build(BuildContext context) {
    var screenSize = MediaQuery.of(context).size;
    return Container(
